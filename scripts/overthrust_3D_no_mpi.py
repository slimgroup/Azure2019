...
# Limit receiver grid
buffersize = 500    # in m
maxoffset = 3287.5  # x/y direction in m
...
# Wavelet
# wavelet = np.load(rootpath + '/overthrust/wavelet/wavelet_3D_2000.npy', allow_pickle=True)
# src.data[:] = wavelet
...
grad, summary2 = tti.gradient(d_obs, u0, v0, sub=(12, 1), isic=True, autotune=('aggressive', 'runtime'))

# Crop PML and extend to full size
rtm = grad.data[model.nbpml:-model.nbpml, model.nbpml:-model.nbpml, model.nbpml:-model.nbpml]  # remove padding
